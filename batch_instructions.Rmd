...
1. Requirements – the files you need to run multieditR in batch mode

2. Upload steps and download of results instructions – how to actually run and save the data

3. Example data - both a parameters table and a full example dataset 

# Requirements

Sample/Control sequence data and parameters excel sheet
